...
export default function Navbar({
  ...
  const navItems = [
    {
      ...
      icon: Package,
      label: "Commandes",
      mobileLabel: "Gestion Commandes",
    },
    {
      key: "inventory" as const,
      icon: ClipboardList,
      label: "Inventaire",
      mobileLabel: "Vérification Inventaire",
    },
    {
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between h-20 max-sm:h-16 px-4 sm:px-6 lg:px-8">
            {/* Logo et titre Assistant */}
            <div className="flex items-center space-x-4 max-sm:space-x-2 group">
  {/* Icône Shield */}
  <div
    className={`p-3 max-sm:p-2 rounded-2xl transition-all duration-300 group-hover:scale-110 ${
      isScrolled
  ...
  >
    <Shield
      className={`h-7 w-7 max-sm:h-5 max-sm:w-5 transition-colors ${
  ...
  {/* Texte Logo */}
  <div className="flex flex-col max-sm:space-y-0.5">
    <span
      className={`text-3xl max-sm:text-2xl font-bold bg-gradient-to-r bg-clip-text text-transparent transition-all ${
        isScrolled
    ...
    <span
      className={`text-xs max-sm:text-[10px] font-semibold tracking-wider ${
    ...
    >
      PANEL ASSISTANT
            ...
            {/* Actions utilisateur */}
            <div className="flex items-center space-x-4 max-sm:space-x-2 max-sm:scale-90">
              {user && (
                <div className="flex items-center space-x-4 max-sm:space-x-2 max-sm:scale-90">
                  {/* Bloc rôle + email */}
                  <div
