  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Revenue et Finances</h1>
          <p className="text-gray-600 mt-1">Analyse détaillée des revenus et performances financières</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`flex items-center text-sm font-medium ${
              ...
              {revenueStats.revenueGrowth >= 0 ? <TrendingUp className="h-4 w-4 mr-1" /> : <TrendingDown className="h-4 w-4 mr-1" />}
              ...
              <div key={category.category} className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    ...
                    style={{ 
                      width: `${(category.revenue / revenueStats.totalRevenue) * 100}%` 
                    }}
                  />
                </div>
              </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {productSales.slice(0, 5).map((sale) => (
                <tr key={sale.product_id} className="border-b border-gray-100 hover:bg-gray-50">
